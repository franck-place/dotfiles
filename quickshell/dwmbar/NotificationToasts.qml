...
// Toast stack, top-right of the primary screen. Toasts from the same app
// stack into one card with a count badge; the newest is shown on top with
...
PanelWindow {
    ...
    // dwm switches to the window's tag/monitor on _NET_ACTIVE_WINDOW.
