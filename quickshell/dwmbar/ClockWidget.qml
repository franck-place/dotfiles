    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                popup.anchor.rect.x = Math.max(8, p.x + cal.width / 2 - popup.implicitWidth / 2);
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    color: dayCell.isToday ? Theme.fgSel
                                         : dayCell.inMonth ? Theme.fg : Theme.fgDim
                                    font.family: Theme.fontFamily
                                    font.pixelSize: 12
