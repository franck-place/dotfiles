...
/* Terminal colors (16 first used in escape sequence) -- rust/espresso theme, matches dwm */
static char *colorname[] = {
	...
	"#d9784f", /* bright red     */
	"#a3b86c", /* bright green   */
	"#e0b84b", /* bright yellow  */
	"#6fa3b5", /* bright blue    */
	"#b58aa0", /* bright magenta */
	"#8fc1b5", /* bright cyan    */
	"#f2e8d5", /* bright white   */
	...
	"#b5651d", /* cursor color: rust/terracotta accent */
	"#1c1714", /* reverse cursor: bg */
	"#c9b79c", /* default foreground colour */
	"#1c1714", /* default background colour */
};
...
/* X resources: colors only -- reloaded live on SIGUSR1, driven by the
   wallpaper picker's pywal pipeline (see ~/.config/wal/templates/colors.Xresources) */
